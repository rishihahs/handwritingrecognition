...
setup(
    ...
    keywords='handwriting ocr neural-network machine-learning',
    ...
    install_requires=['scipy>=0.15.0', 'numpy>=1.9.0', 'matplotlib>=1.4.0'],
    ...
    entry_points={
        'console_scripts': [
            'handwritingrecognition=handwritingrecognition:main',
        ],
    },
)
